  ...
  return (
    <div className="relative h-91v">
      <div className="flex h-full flex-col items-center justify-center gap-10 p-12">
        <p className="text-center text-xl font-bold dark:text-white md:text-4xl">
      ...
      {/* Blobs */}
      <svg
        className="absolute bottom-0 left-0 -z-10 h-32 w-32 overflow-visible fill-current text-primary-light dark:text-cardcolor md:h-64 md:w-64"
        viewBox="0 0 434 424"
      >
      ...
      <svg
        className="absolute -right-20 bottom-20 -z-10 h-48 w-48 fill-current text-primary-light dark:text-cardcolor md:h-96 md:w-96"
        viewBox="0 0 365 663"
      >
