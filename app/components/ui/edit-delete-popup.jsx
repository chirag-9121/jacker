  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="max-w-16" align="end">
        <DropdownMenuItem className="mb-0.5 flex gap-2 text-xs text-iconblue focus:bg-iconblue/10 focus:text-iconblue">
          <RiEditFill />
          Edit
        </DropdownMenuItem>
        <DropdownMenuItem
          onClick={deleteJobHandler}
          className="flex gap-2 text-xs text-error focus:bg-error/10 focus:text-error"
        >
          <FaTrash size={10} />
          Delete
        </DropdownMenuItem>
